...
Example:
![[Sem1/MA1110/Images/image7.png]]

![[Sem1/MA1110/Images/image8.png]]
...
Eg: ![[Sem1/MA1110/Images/image9.png]]
...
**Big O Notation**
![[Sem1/MA1110/Images/image10.png]]

**Alternative Form of Gauss's Test**
Let $\sum_{n=1}^{\infty}a_n$ be a series of positive real numbers. If

$a_n/a_{n+1}=1+\alpha / n + O(1/n^p), p > 1$, then the series converges if $\alpha > 1$ and diverges if $\alpha \le 1$
