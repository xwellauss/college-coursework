...
- **Lithosphere**: continental + oceanic crust + solid upper mantle, resting on the partially molten asthenosphere.
- Without atmosphere, Earth's avg temp would be **–18°C** instead of +15°C (greenhouse effect).
...
- **Fractional distillation** of crude oil separates by boiling point (C1–C5 gases → …→ >C70 residue).
- **LPG**: mainly propane + butane; odourless; mercaptan added for leak detection; 220–2200 kPa.
- **Natural gas**: mainly methane; CNG compressed at 20–25 MPa; mercaptan added.
...
- Wind: caused by (1) uneven heating → convection, (2) Earth's rotation. ~1.6×10⁷ MW available globally; 2025: wind supplied ~2700 TWh (~8% of world electricity).
- **Nuclear fission**: U-235 + n → Ba-144 + Kr-89 + 3n + Energy.
...
- **Geothermal**: steam wells up to 1000 m, 200–300°C; needs moisture/particle separation before turbine.
- **OTEC** (Ocean Thermal Energy Conversion): uses temperature gradient (surface vs deep water, 20–25°C difference); low-boiling fluid (ammonia/propane) drives turbine.
...
**Metabolic pathways** intermediates enter: β-oxidation (fatty acids/hydrocarbons), TCA (citric acid) cycle, Glycolysis, Electron transport chain.

- **β-oxidation**: carboxyl group at C-1 activated via coenzyme A → stepwise oxidation at C-3 (β-position).
- Detergent/petroleum breakdown: terminal oxidation of hydrocarbon chain → carboxylic acid → β-oxidation; catalyzed by **cytochrome P-450** (a monooxygenase).
...
- C + O₂ → CO₂, ΔH ≈ –400 kJ/mol.
- Moles of CO₂ produced/yr ≈ 5×10²⁰ J ÷ 4×10⁵ J/mol ≈ **1.25×10¹⁵ mol**.
- Volume of that CO₂ at STP (22.4 L/mol) ≈ **2.83×10¹³ m³**.
- **Scattering vs Absorption**: visible light scattered by O₂/N₂ (Rayleigh scattering → blue sky); IR absorbed by GHGs.
...
- **Paris Agreement (2015)**: limit warming well below 2°C, preferably 1.5°C above pre-industrial levels.
...
- **3R**: Reduce (source reduction) → Reuse → Recycle.
...
6. Design for Energy Efficiency (ambient T/P preferred)
7. Use of Renewable Feedstocks
8. Reduce Derivatives (avoid unnecessary protection/deprotection)
9. Catalysis (catalytic > stoichiometric reagents)
10. Design for Degradation (products break down harmlessly)
...
- **Label elements**: Product identifier, Signal word (Danger=severe / Warning=less severe), Hazard statement, Pictogram(s), Precautionary statement, Manufacturer info.
- **Pictograms** (black symbol, white background, red diamond frame): Health hazard (carcinogen etc.), Environment (aquatic toxicity), Exclamation mark (irritant), Skull & crossbones (acute toxicity), Gas cylinder (pressure), Corrosion, Exploding bomb (explosives), Flame over circle (oxidizers), Flame (flammables).
...
- Solar constant at Earth's orbit: 1377 W/m²
- Sun's power output: 3.84×10²⁶ W
- Global energy use: ~500 EJ/yr
- CO₂ moles produced/yr: ~1.25×10¹⁵ mol
- SF₆ GWP: 22,800× CO₂ (highest)
- CH₄ GWP: 25; N₂O GWP: 298
- SMR gives 50% of world H₂; coal gasification 20%; electrolysis 4%
